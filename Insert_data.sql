...
VALUES
(900001,'Paris','Carbone','paris.carbone@uni.se','070-111'),
(900004,'Leif','Lindbäck','leif.linback@uni.se','070-222'),
(900009,'Niharika','Gauraha','niharika.g@uni.se','070-333'),
(900010,'Brian','Karlsson','brian.k@uni.se','070-444'),
(900011,'Adam','West','adam.w@uni.se','070-555'),
(900100,'Test','TeacherOverload','test.overload@uni.se','070-999');


INSERT INTO Employee(employ_id, personal_id, job_title, salary, dept_identifier)
VALUES
...
INSERT INTO CourseLayout(course_code, hp, course_name, min_students, max_students, valid_from)
VALUES
('IV1351', 7.5, 'Data Storage Paradigms', 50, 250, '2023-01-01'),
('IX1500', 7.5, 'Discrete Mathematics', 50, 150, '2023-01-01');


INSERT INTO CourseInstance(courselayout_id, period, year, num_students)
VALUES
...
WHERE ci.period='P2' AND ci.year=2025 AND ci.courselayout_id =
     (SELECT course_layout_id FROM CourseLayout WHERE course_code='IV1351');
...
WHERE ci.period='P1' AND ci.year=2025 AND ci.courselayout_id =
     (SELECT course_layout_id FROM CourseLayout WHERE course_code='IX1500');
...
WHERE ci.period='P2' AND ci.year=2025
 AND ci.courselayout_id = (SELECT course_layout_id FROM CourseLayout WHERE course_code='IV1351')
LIMIT 1;
...
FROM CourseInstance ci
JOIN ActivityType at ON at.activity_name='Lecture'
WHERE ci.period='P1' AND ci.year=2025
 AND ci.courselayout_id = (SELECT course_layout_id FROM CourseLayout WHERE course_code='IX1500');


INSERT INTO Allocation(employee_id, courseinstance_id, activitytype_id, hours_allocated)
SELECT 500100, ci.courseinstance_id,
      (SELECT activitytype_id FROM ActivityType WHERE activity_name='Lecture'),
      10
FROM CourseInstance ci
WHERE ci.year=2025
